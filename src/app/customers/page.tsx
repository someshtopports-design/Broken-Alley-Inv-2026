...
import { Crown, Phone, MapPin, ShoppingBag, Users } from "lucide-react";
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-zinc-100">
                                        {["Customer", "Mobile", "Area", "Purchases", "Total Spent", "Status"].map(
                                            (h) => (
                                                <th
                                                    key={h}
                                                    className="text-left px-5 py-3 font-semibold text-zinc-500 uppercase text-xs tracking-wide whitespace-nowrap"
                                                >
                                                    {h}
                                                </th>
                                            )
                                        ...
                                        return (
                                            <tr
                                                ...
                                                className={cn(
                                                    ...
                                                    customer.isPremium && "bg-amber-50/30 hover:bg-amber-50/50"
                                                )}
                                            >
                                                ...
                                                <td className="px-5 py-3.5">
                                                    {customer.isPremium ? (
                                                        ...
                                                        <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-zinc-100 text-zinc-500 text-xs font-medium rounded-full">
                                                            Regular
                                                        </span>
                                                    )}
                                                </td>
                        ...
                        {customers.map((customer) => {
                            ...
                            return (
                                <Card
                                    ...
                                    className={cn(
                                        "p-4",
                                        customer.isPremium && "border-amber-200 bg-amber-50/30"
                                    )}
                                >
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-3">
                                        ...
                                        {customer.isPremium ? (
                                            ...
                                            <span className="inline-flex px-2 py-0.5 bg-zinc-100 text-zinc-500 text-xs font-medium rounded-full">
                                                Regular
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 mt-3 pt-3 border-t border-zinc-100 text-xs text-zinc-500">
                                        ...
                                        {totalSpent > 0 && (
                                            <span className="font-semibold text-zinc-700 ml-auto">
